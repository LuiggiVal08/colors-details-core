...
function ut(t, s) {
    if (!t) return t;
    if (ht(t)) {
        const i = { _placeholder: !0, num: s.length };
        return (s.push(t), i);
    }
    if (Array.isArray(t)) {
...
class Et extends k {
    ...
    connect() {
        return (
            this.connected || (this.subEvents(), this.io.ot || this.io.open(), 'open' === this.io.ht && this.onopen()),
            this
        );
    }
    open() {
    ...
    emit(t, ...s) {
        ...
        if ((s.unshift(t), this.p.retries && !this.flags.fromQueue && !this.flags.volatile)) return (this.ct(s), this);
    ...
    ct(t) {
        ...
        (t.push((t, ...e) => {
            ...
            return (
                null !== t
                    ? i.tryCount > this.p.retries && (this.et.shift(), s && s(t))
                    : (this.et.shift(), s && s(null, ...e)),
                (i.pending = !1),
                this.ft()
            );
        }),
    ...
    dt(t) {
        this.packet({ type: yt.CONNECT, data: this.yt ? Object.assign({ pid: this.yt, offset: this.bt }, t) : t });
    }
    onerror(t) {
        this.connected || this.emitReserved('connect_error', t);
    }
    onclose(t, s) {
        ((this.connected = !1), delete this.id, this.emitReserved('disconnect', t, s), this.gt());
    }
    gt() {
    ...
    emitEvent(t) {
        if (this.wt && this.wt.length) {
            const s = this.wt.slice();
            for (const i of s) i.apply(this, t);
        }
        (super.emit.apply(this, t),
            this.yt && t.length && 'string' == typeof t[t.length - 1] && (this.bt = t[t.length - 1]));
    }
    ack(t) {
        const s = this;
        let i = !1;
    ...
    destroy() {
        (this.subs && (this.subs.forEach((t) => t()), (this.subs = void 0)), this.io.vt(this));
    }
    disconnect() {
        return (
...
class _t extends k {
    constructor(t, s) {
        ...
        ((this.encoder = new e.Encoder()),
            ...
            (this.rt = !1 !== s.autoConnect),
            this.rt && this.open());
    }
    reconnection(t) {
        return arguments.length ? ((this.At = !!t), t || (this.skipReconnect = !0), this) : this.At;
    }
    reconnectionAttempts(t) {
        return void 0 === t ? this.Et : ((this.Et = t), this);
    }
    reconnectionDelay(t) {
        var s;
        return void 0 === t
            ? this.Ot
            : ((this.Ot = t), null === (s = this.backoff) || void 0 === s || s.setMin(t), this);
    }
    randomizationFactor(t) {
        var s;
        return void 0 === t
            ? this._t
            : ((this._t = t), null === (s = this.backoff) || void 0 === s || s.setJitter(t), this);
    }
    reconnectionDelayMax(t) {
        var s;
        return void 0 === t
            ? this.jt
            : ((this.jt = t), null === (s = this.backoff) || void 0 === s || s.setMax(t), this);
    }
    timeout(t) {
        return arguments.length ? ((this.xt = t), this) : this.xt;
    }
    maybeReconnectOnOpen() {
        !this.ot && this.At && 0 === this.backoff.attempts && this.reconnect();
    }
    open(t) {
        if (~this.ht.indexOf('open')) return this;
        this.engine = new tt(this.uri, this.opts);
        const s = this.engine,
            i = this;
        ((this.ht = 'opening'), (this.skipReconnect = !1));
    ...
    onopen() {
        (this.cleanup(), (this.ht = 'open'), this.emitReserved('open'));
        const t = this.engine;
        this.subs.push(
    ...
    socket(t, s) {
        let i = this.nsps[t];
        return (i ? this.rt && !i.active && i.connect() : ((i = new Et(this, t, s)), (this.nsps[t] = i)), i);
    }
    vt(t) {
    ...
    reconnect() {
        ...
        const t = this;
        if (this.backoff.attempts >= this.Et)
            ...
            const i = this.setTimeoutFn(() => {
                t.skipReconnect ||
                    ...
                    t.skipReconnect ||
                        t.open((s) => {
                            s ? ((t.ot = !1), t.reconnect(), this.emitReserved('reconnect_error', s)) : t.onreconnect();
                        }));
            }, s);
            (this.opts.autoUnref && i.unref(),
                this.subs.push(() => {
